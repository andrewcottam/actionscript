package com.as3xls.xls {
	...
	import wcmc.classes.SpeciesCounts;
	...
	public class Sheet {
		...
		public function getSpeciesCounts():ArrayCollection{
			var counts:ArrayCollection = new ArrayCollection();
			for(var r:uint = 1; r < _values.length-1; r++)
			{
				var speciesCount:SpeciesCount = new SpeciesCount();
				speciesCount.id=r+1;
				speciesCount.siteCode=_values[r][0].value;
				speciesCount.siteName= _values[r][1].value;
				speciesCount.date= _values[r][2].value;
				speciesCount.speciesCode= _values[r][3].value;
				speciesCount.count= _values[r][4].value;
				speciesCount.coverage= _values[r][5].value;
				speciesCount.quality= _values[r][6].value;
				counts.addItem(speciesCount);
			}	
			return counts;
		}
	}
